<div class="container-fluid mt-2 p-2">
                        ...
                        data-url="<?= base_url('projetos/retAllProjects') ?>">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="dtEntregaProjeto" data-halign="center" data-align="center" data-sortable="true">Data final prevista</th>
    ...
    <script>
        function optProject(index, row) {
            return `<button type="button" class="btn btn-outline-success btn-sm" onclick='altProjeto(` + JSON.stringify(row) + `);'><i class="fas fa-edit"></i></button> <button type="button" class="btn btn-outline-danger btn-sm" onclick="delProjeto(` + row.id_projeto + `);"><i class="fas fa-trash-alt"></i></button>`;
        }
